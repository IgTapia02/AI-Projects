...
public class NegaMax : PlayerBase
{
    int depth = 3;
    int nNodes = 0;
    struct Move_
   ...
   override protected GameObject SpawnPiece()
    {
        ...
        Move_ nextMove = NegaMaxAlgorithm(actualmove);
    ...
    Move_ NegaMaxAlgorithm(Move_ _actualMove)
    {
        ...
        foreach (int move in moves)
        {
            ...
            Move_ resultMove = NegaMaxAlgorithm(newMove);
